...
//$_SERVER['DOCUMENT_ROOT'] will get the root of the site url
define('BASE_URL', $_SERVER['DOCUMENT_ROOT'].'/new/fashionboutique/');

define('CART_COOKIE', 'RandomString12345fashionBoutique');
